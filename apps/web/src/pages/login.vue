...
<template>
  <AuthBox>
    ...
    <template v-slot:content>
      <el-form ref="ruleFormRef" :model="ruleForm" status-icon label-position="top" :rules="rules" label-width="120px"
        class="demo-ruleForm" mt-7 flex="~ col" justify-between h-full>
        ...
        <el-form-item class="login-button" w-full flex mt-2>
          <o-button type="success" @click="submitForm(ruleFormRef)" @keydown.enter="keyDown($event)" w-23 flex-1
            work-spacing-5 mr-2>
            登&nbsp;&nbsp;&nbsp;陆
          </o-button>
